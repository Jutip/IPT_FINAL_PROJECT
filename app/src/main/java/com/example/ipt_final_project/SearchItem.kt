...
class SearchItem (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val button = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_search, parent, false) as android.widget.Button
    ...
    fun filter(query: String) {
        filteredList = if (query.isEmpty()) itemList
        else itemList.filter { it.contains(query, ignoreCase = true) }
